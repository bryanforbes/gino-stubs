...
from typing import Any, Optional, Type, Generic, TypeVar, AsyncIterator, Generator, Generic, List
...
class DBAPICursor:
    ...
    async def prepare(self, context: Any, clause: Optional[Any] = ...) -> PreparedStatement[Any]: ...
...
class _ResultProxy(Generic[_T]):
    ...
    async def execute(self, one: bool = ..., return_model: bool = ..., status: bool = ...) -> Any: ...
