...
class Pool(base.Pool[asyncpg.pool.Pool[_R], asyncpg.pool.PoolConnectionProxy[_R]]):
    def __init__(self, url: Any, loop: Any, **kwargs: Any) -> None: ...
    def __await__(self) -> Generator[Any, None, Pool[_R]]: ...
    @property
    def raw_pool(self) -> asyncpg.pool.Pool[_R]: ...
    async def acquire(
        self, *, timeout: Optional[Any] = ...
    ) -> asyncpg.pool.PoolConnectionProxy[_R]: ...
...
class AsyncpgDialect(PGDialect, base.AsyncDialectMixin):
    ...
    @overload
    async def init_pool(self, url: Any, loop: Any) -> Pool[Any]: ...
    @overload
